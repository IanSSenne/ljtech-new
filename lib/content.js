...
// languages I use
export const languages = ["HTML", "CSS", "JavaScript", "PHP", "MySQL"];

// portfolio page tabs
export const tabs = ["Apps", "Art", "Components", "Games", "All"];

// portfolio page products
export const products = ["Adobe Products", "Figma"];
...
export const apps = [
	{
		...
		src: "../800x600.png",
		content:
			"Yay this works, now I can type stuff here to describe what my application or thing is woo.",
	},
	{
		id: "pipes-up",
		name: "Pipes Up",
